<?php
/*
Template Name: pre-entry-confirm Template
*/
    ...
    <script>
        $(document).ready(function() {
            $('.submit-btn').click(function(e) {
                ...
                var industry_val = document.querySelector("#pre-entry-form > ul > li.horizontal-wrapper.pc-only > div:nth-child(1) > input[type=hidden]:nth-child(2)").value;
                var occupation_val = document.querySelector("#pre-entry-form > ul > li.horizontal-wrapper.pc-only > div:nth-child(2) > input[type=hidden]:nth-child(2)").value;
                const formData = {
                ...
                $.ajax({
                    url: 'http://go.cxo-jinzaibank.jp/l/1022123/2023-08-16/c9yr',
                    type: 'POST',
                    data: formData,
