        ...
        <section class="features">
            ...
            <div class="container pc">
                ...
                <div class="feature-wrapper type1">
                    ...
                    <div class="content-wrapper">
                        ...
                        <p class="desc">
                        CxO人材バンクでは、企業様との面接には原則同席し、より高い評価を得られるよう、ご自身のキャリアにおける評価ポイントをしっかり伝えます。<br><br>
                ...
                <div class="feature-wrapper type2">
                    <div class="content-wrapper">
                        ...
                        <p class="desc">
                        CxO人材バンクは、単に求人案件を紹介するだけでなく、コンサルタントとオフラインで交流できる機会も創っており、皆さまとの表面的ではない繋がりや、双方の理解を深めることを大切にしています。<br><br>
            ...
            <div class="container sp">
                ...
                <div class="feature-wrapper type2">
                    ...
                    <div class="image-wrapper">
                        <img src="<?php echo T_DIRE_URI; ?>/assets/img/feature004.png">
                        <p class="desc">↑候補者情報を経営者の方たちに見ていただいています。
</p>
                    </div>
                </div>
                <a class="btn-rightarrow" href="<?php echo HOME . 'features/background'; ?>">
