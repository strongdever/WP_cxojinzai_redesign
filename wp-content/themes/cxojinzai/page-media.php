...
<main id="features-media">
        ...
        <div class="container">
            ...
            <div class="part5">
                ...
                <p class="desc">
                CxO人材バンクは、IPO・経営戦略やIR活動に関する支援しているため、成長企業の経営者と定期的に交流する機会があります。<br>企業経営者に直接提案するだけでなく、会員制グループやメルマガなどで候補者の情報を共有しているので、経営者本人から「この方と会ってみたい」とオファーがあります。
                </p>
                <div class="img-wrapper">
