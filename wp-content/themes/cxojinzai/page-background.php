    ...
    <main id="features-background">
        ...
        <div class="container">
            <div class="part1">
                ...
                <p class="desc">
                CxO人材バンクは、株式会社ベクトルと株式会社ミンカブ・ジ・インフォノイドのジョイントベンチャー「株式会社IR Robotics」が運営しています。<br>成長企業がより成長するための支援として、サービスの提供先を「上場企業」「上場準備中企業」「将来の上場を考えている企業」という3つのカテゴリーに絞った事業展開をしています。
                </p>
            </div>
            <div class="part2">
                <div class="left-wrapper">
                    ...
                    <p class="desc">
                    CxO人材バンクが考える成長企業とは「上場企業」「上場準備中企業」「将来の上場を考えている企業」の中で、自社の企業価値向上に積極的に取り組む企業を指します。<br>私たちは「成長企業がより成長するための支援を通じ、ともに成長し、日本経済の発展に寄与する」を企業理念に掲げ、これからも『成長企業がより成長するためのビジネスプラットフォームになる』をビジョンに、全国の成長企業が真に必要としているCxO人材をご紹介できるよう努めて参ります。
                    </p>
                </div>
                ...
                <div class="window last">
                    ...
                    <div class="content">
                        ...
                        <div class="wrapper">
                            ...
                            <p class="desc">
                            経営の中枢を担う「CxOポジション」を中心に、転職をサポートします。当事業を通して、企業の経営課題解決・企業成長に加速の一助となることを目指して参ります。
                            </p>
                        </div>
                        <div class="wrapper">
                            ...
                            <p class="desc">
                            上場企業や上場準備中企業でご活躍している経営者やCxOに、これまでのキャリアや仕事論についてMCが深堀りしていく番組です。<br>転職のタイミングやその意思決定した理由などCxOになるまでの裏側を紐解いていきます。
                            </p>
                        </div>
                    </div>
                </div>
